...
class ExtractForm(Form):
  search_property = SelectField(u'Select a Property')
  brand_queries = StringField('Brand queries', validators=[DataRequired("Please enter your brand queries for the property separated by commas.")])
